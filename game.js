    ...
    // knight attack
        ...
        this.input.on('pointerdown', function (pointer) {
            ...
            for (let b = 0; b < this.goblinArray.length; b++){
                const destroygoblin = (slash, goblin) => {
                ...
                if (this.slash) {
                    this.physics.add.collider(this.slash, this.goblinArray[b], destroygoblin, null, this) // adds collision between the slash and all goblins
                }
            }
